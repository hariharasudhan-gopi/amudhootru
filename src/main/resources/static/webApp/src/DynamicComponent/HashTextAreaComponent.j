...
const HashTextAreaComponent = (properties) => {
    ...
    <div className={'hashComponent ' + properties.fieldClass}>
      ...
      {properties.isEditable ? (
        <span className='fieldContainer'>
          <textarea type= {properties.type} className = {properties.applicantType + "_" + properties.id} placeholder = {properties.placeholder} onBlur={(eve) => hashFocusOut(eve)} value={properties.fieldValue ? properties.fieldValue : undefined}></textarea>
...
export default HashTextAreaComponent
